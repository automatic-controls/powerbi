...
set "reportServices=%~dp0Scheduled Report Vehicle Maintenance Report.csv"
...
(
  ...
  if !ErrorLevel! EQU 0 (
    ...
    if exist "%reportServices%" del /F "%reportServices%" >nul 2>nul
  ) else (
    echo !err!
